...
import com.movie.api.auth.CxAuthorizationFilter;
...
public class CxSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilter(new CxAuthorizationFilter(authenticationManagerBean()));
